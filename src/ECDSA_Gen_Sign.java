...
public class ECDSA_Gen_Sign {
  public static void main(String[] args) throws GeneralSecurityException, IOException {
    ...
    // Generate an ECDSA keypair
	  ECGenParameterSpec ecSpec = new ECGenParameterSpec("secp256r1");  //secp256k1 curve
    ...
    ks.setKeyEntry("ECDSAPublicKey", pubKey, CARDSET_PASSPHRASE, null);
    ...
    ks.setKeyEntry("ECDSAPrivateKey", privKey, CARDSET_PASSPHRASE, certChain);
