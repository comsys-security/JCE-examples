...
public class crtgenerator {
	...
	private static String alias = "Root RSA Key"; // 
	...
	X500Name owner, X500Name xname) throws OperatorCreationException, CertificateException, InvalidKeyException, NoSuchAlgorithmException, NoSuchProviderException, SignatureException{
		...
		ContentSigner signer = new JcaContentSignerBuilder("SHA256WithRSA").build(root_privateKey);
	...
	public static void main(String[] args) throws Exception{
		...
		PublicKey CApublickey = KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(csr.getSubjectPublicKeyInfo().toASN1Primitive().getEncoded()));
